...
const GetStarted = () => {
    ...
    return (
        <>    
        <div className="row my-20 px-11 d-flex align-items-center justify-content-center">
        {/* Image 1 */}
        ...
        <div className="col-md-6 px-9">
          <div className="list-section">
            <h3 className="text-light-blue-900 fs-4">Expertise Multidisciplinaire au Service de Votre Entreprise</h3>
      ...
      <div className="row my-20 px-11 d-flex align-items-center justify-content-center">
        ...
        <div className="col-md-6 mb-4 mb-md-0 px-9">
          <div className="list-section">
            <h3 className="text-light-blue-900 fs-4">Des Services de Qualité pour Optimiser Votre Gestion Financière et Sociale</h3>
